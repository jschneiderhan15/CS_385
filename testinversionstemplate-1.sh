#!/bin/bash
#John Schneiderhan and Aleks Sekulovski
...
run_test_args "slow" "$(echo {1000..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 499500"
run_test_args "slow" "1 1 4 3 2" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_args "slow" "1 2" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "slow" "3 1 0 1 2 9" "Enter sequence of integers, each followed by a space: Number of inversions: 5"
run_test_args "slow" "-1 -2 -3 -4" "Enter sequence of integers, each followed by a space: Number of inversions: 6"
run_test_args "slow" "-4 -3 -2 -1" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "slow" "1 1 1 1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
...
run_test_args "" "$(echo {1000..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 499500"
run_test_args "" "1 1 4 3 2" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_args "" "1 2" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "" "3 1 0 1 2 9" "Enter sequence of integers, each followed by a space: Number of inversions: 5"
run_test_args "" "-1 -2 -3 -4" "Enter sequence of integers, each followed by a space: Number of inversions: 6"
run_test_args "" "-4 -3 -2 -1" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "" "1 1 1 1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
