...
size_t lomuto_partition(int array[], size_t left, size_t right) { //algorithm from the textbook
	int p = array[left];
	size_t s = left;
...
int quick_select(int array[], size_t left, size_t right, size_t k) { //algorithm from the textbook made nonrecursive
